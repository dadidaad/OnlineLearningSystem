...
public class AccountManagerSearchController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (searchString.equals("")) response.sendRedirect("AccountManager");
            ...
            ArrayList<AccountBean> accounts = iAccountDAO.getAllAccountBySearch(searchString, pageindex, pagesize);

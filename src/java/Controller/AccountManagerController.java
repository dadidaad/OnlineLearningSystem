...
/**
 * This is a Servlet responsible for handling the task when the Admin wants to ban or active an account
...
public class AccountManagerController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<AccountBean> accounts = iAccountDAO.getAllAccount(pageindex, pagesize);

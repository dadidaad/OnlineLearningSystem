...
/**
 * This class contain method to find Knowledge information from database Extend
 * BaseDAO class to call getConnection() method Implement IKnowledgeDAO
 * Interface
 *
 * @author Doan Tu
 */
public class KnowledgeDAO extends BaseDAO implements IKnowledgeDAO {
     ...
     *
     * @param chapId ID of Chapter which Knowledge belongs.
     * <code>java.lang.Intege</code>
    ...
    /**
     * getNumberOfKnowledgeByChapterId method This method will count number of
     * all Knowledge with corresponding ChapterID
     *
     * @param chapId. Id of Chapter which wanted to get Knowledge.
    ...
    /**
     * getNumberOfKnowledge method This method will count All Knowledge
    ...
    /**
     * createKnowledge Method This method will insert new Knowledge into
     * database
     *
    ...
    /**
     * searchByKnowledgeNameOfChap method This method will get Knowledge which
     * has corresponding knowledgeName, and Chapter ID
     *
     * @param knowledgeName. Name Of Knowledge we want to
     * search.<code>java.lang.String</code> Object

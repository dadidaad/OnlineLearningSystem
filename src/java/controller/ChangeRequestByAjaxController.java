 ...
 * see the list of Request by type of status /ChangeRequestByAjax is the URL of
 * the Servlet Extend HttpServlet class
 *
 * @author Duc Minh
 */
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (account.getRole().equalsIgnoreCase("student")) {
                ...
                for (RequestBean r : requestList) {
                    String htmlStar = "";
                    if (account.getUsername().equalsIgnoreCase(r.getTutorGet())) {
            ...
            Logger.getLogger(ChangeRequestByAjaxController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

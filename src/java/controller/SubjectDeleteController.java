 ...
 * @author Phong Vu
 */
@WebServlet(name = "SubjectDeleteController", urlPatterns = {"/SubjectDeleteController"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (ChapterBean chapter : chapters) {
                chapterDAO.deleteChapterById(chapter.getChapterID());
            }
            subjectDAO.deleteSubject(Integer.parseInt(subId));
            
            response.sendRedirect("AdminSubjectController");
        } catch (SQLException ex) {
            Logger.getLogger(SubjectDeleteController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

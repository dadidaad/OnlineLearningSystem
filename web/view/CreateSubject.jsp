            ...
            <form action="CreateSubjectController" id="form" method="Post" enctype="multipart/form-data">
                <div class="user-detail">
                    <div class="input-box">
                        ...
                        <input type="text" id="subId" name="subId" placeholder="Subject ID here" required value="${requestScope.nextId}" readonly="true">
                    </div>

                    <div class="input-box">
                        <span class="details" >Subject Name</span>
                        <input type="text" id="subName" placeholder="Subject Name here" name="subName">

                    </div>

                    <div class="input-box">
                        <span class="details">Description</span>
                        <input type="text" id="description" placeholder="Subject Description here" name="description">
                    </div>

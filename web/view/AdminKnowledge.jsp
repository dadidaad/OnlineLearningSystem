            ...
            <section class="recent">
                <div class="activity-grid">
                    <div class="activity-card">
                        <h3 class="">All Knowledge for ${requestScope.chapter.getChapterName()}</h3> <span class="new-subject"><a href="CreateChapterController?subId=${requestScope.chapter.getChapterID()}">Add New Knowledge</a></span>
                        <table borders="2">
                            <thead>
                                <tr>
                                    <th>KnowledgeID</th>

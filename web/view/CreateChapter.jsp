...
<html>
    ...
    <body>
        ...
        <!--Create New Chapter -->
        <div class="container">
            <div class="title">New Chapter</div>
            <form action="CreateChapterController" id="form" method="Post">
                <div class="user-detail">
                    <div class="input-box">
                        <span class="details">ChapterID</span>
                        <input type="text" id="subId" name="chapId" placeholder="Chapter ID here" required value="${requestScope.nextId}" readonly="true">
                    </div>

                    <div class="input-box">
                        <span class="details" >Chapter Name</span>
                        <input type="text" id="subName" placeholder="Chapter Name here" name="chapName">

                    </div>

                    <div class="input-box">
                        <span class="details">Chapter Content</span>
                        <input type="text" id="description" placeholder="Chapter Content here" name="chapContent">
                    </div>

                    <div class="input-box">
                        <span class="details">SubjectID</span>
                        <input type="text" id="subId" name="subId" placeholder="Subject ID here" required value="${requestScope.subId}" readonly="true">
                    </div>
